...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'jaiswalabhay517@gmail.com', // gmail
...
exports.cookieExtractor = function (req) {
  ...
  token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0ZGRiZjhiNDA2OTA3OTgzNTFhOTQyMCIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTY5MjI3MjQ4Nn0.8YXG94jAaE6iqZzBxF0yt-1PWCTnnHMQ1XhiddaYjrM"
  return token;
};
...
exports.sendMail = async function ({to, subject, text, html}){
    let info = await transporter.sendMail({
        from: '"MasterKart" <jaiswalabhay517@gmail.com>', // sender address
        to,
        subject,
        text,
        html
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="jaiswalabhay517@gmail.com">contact us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
